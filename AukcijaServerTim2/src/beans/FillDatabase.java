...
public class FillDatabase {
	...
	private String[] velicina = { "XS", "S", "M", "L", "XL", "XXL", "37", "38", "39", "40", "41", "42", "43", "44",
			"45" };
	private String[] tipov = { "majica", "pantalone", "kosulja", "haljina", "sako", "sorc", "suknja", "patike",
			"cipele", "papuce", "sandale", "cizme", "zimska obuca", "stikle" };
